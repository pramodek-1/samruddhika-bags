...
export const products: Product[] = [
  ...
  {
    id: '12',
    name: 'Tommy School & ClassBackPack',
    description: 'Best School & Class BackPack for Boys and Girls',
    price: 1899,
    category: 'class-bags',
    image: '/images/products/tommy_main.jpg',
  },
  {
    id: '13',
    name: 'Leather Side Bag',
    description: 'Excellent Side Bag for Boys',
    price: 1599,
    category: 'class-bags',
    image: '/images/products/leatherSide_main.jpg',
  },
  {
    id: '14',
    name: "Fila 'L' School BackPack",
    description: 'Best School Bag for Grade 6-8',
    price: 1499,
    category: 'school-bags',
    image: '/images/products/filaL_main.jpg',
  },
  {
    id: '15',
    name: "Fila 'S' School BackPack",
    description: 'Best School Bag for Grade 1-3',
    price: 1399,
    category: 'school-bags',
    image: '/images/products/filaS_main.jpg',
  },
  {
    id: '16',
    name: "Army XL BackPack",
    description: 'Perfect bag for Army & Police',
    price: 3299,
    category: 'travelling-bags',
    image: '/images/products/army_main.jpg',
  },
  {
    id: '17',
    name: "Army Travelling Bag",
    description: 'Perfect bag for Army & Police Carrying Gods',
    price: 3299,
    category: 'travelling-bags',
    image: '/images/products/armyTravelling_main.jpg',
  },
  {
    id: '18',
    name: "Lunch Bag for Lunch Box",
    description: 'Best Bag for Carrying Lunch Box',
    price: 599,
    category: 'pocket-bags',
    image: '/images/products/lunchBag_main.jpg',
  },
  {
    id: '19',
    name: "Vans Clear Bag",
    ...
    price: 899,
    category: 'class-bags',
    image: '/images/products/clear_main.jpg',
  }
];