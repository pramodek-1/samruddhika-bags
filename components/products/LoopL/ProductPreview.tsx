...
import { product, relatedProducts } from '@/components/data/LoopL/productData'
import { ProductImage } from '@/components/products/LoopL/ProductImage'
import { ProductInfo } from '@/components/products/LoopL/ProductInfo'
import { ProductDescription } from '@/components/products/LoopL/ProductDescription'
import { RelatedProducts } from '@/components/products/LoopL/RelatedProducts'
